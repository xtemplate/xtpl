 ...
 * `npm install xtpl`
 *
 *  @see https://github.com/kissyteam/kissy/blob/master/lib/xtemplate.js
 */
var S = require('./ks-lib/seed');
var fs = require('fs');
var iconv;
try {
...
function renderFile(path, options, callback) {
    ...
    var encoding = options.settings['view encoding'] || 'utf-8';
    var moduleName = normalizeSlash(path.substring(viewDir.length + 1).slice(0, -extName.length - 1));
    try {
        callback(null, module.exports.loadFromModuleName(moduleName, {
