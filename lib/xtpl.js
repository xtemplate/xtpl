...
function render(path, data, options, callback) {
    ...
    var engine = getInstance({
        name: path,
        extname: options.extname || Path.extname(path),
        loader: loader,
        catchError: options.catchError === undefined ? globalConfig.catchError : options.catchError,
        cache: options.cache === undefined ? globalConfig.cache : options.cache,
        encoding: options.encoding || globalConfig.encoding
    });
    // runtime commands
